...
//glue.log("DEBUG", "RESULT WAS ", ncbiCurated);
...
_.each(ncbiCurated, function(ncbiCurated) {
	...
	//glue.log("DEBUG", "ID RESULT WAS ", sequenceID);
	//glue.log("DEBUG", "WHERE CLAUSE RESULT WAS ", serotypeWhereClause);
	//glue.log("DEBUG", "sourceName RESULT WAS ", sourceName);
	//glue.log("DEBUG", "Serotype RESULT WAS ", serotype);
	...
	glue.inMode("/module/chikvMaxLikelihoodGenotyper", function() {
		...
		//glue.log("DEBUG", "Genotype 1 RESULT WAS ", genotypeResults1);			
	});
	...
	//glue.log("DEBUG", "Genotype RESULT WAS ", genotypeResult);
